package com.sevenpyramid.comparewine.constant;
...
public class Cons {
	...
	public static final String H_Vintage="Vintage";
	public static final String H_Price_Euro="Price Euro";
	public static final String H_Price_US="Price US";
	public static final String H_Bottle_Size="Bottle Size";
